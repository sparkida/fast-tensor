...
export interface WasmModule {
    ...
    _tensor_maximum: (tensorPtr: number, otherPtr: number) => number;
    _tensor_maximum_scalar: (tensorPtr: number, scalar: number) => number;
    _tensor_minimum: (tensorPtr: number, otherPtr: number) => number;
    _tensor_minimum_scalar: (tensorPtr: number, scalar: number) => number;
    _tensor_mod: (tensorPtr: number, otherPtr: number) => number;
    _tensor_mod_scalar: (tensorPtr: number, scalar: number) => number;
    _tensor_pow: (tensorPtr: number, otherPtr: number) => number;
    _tensor_pow_scalar: (tensorPtr: number, scalar: number) => number;
    _tensor_squared_diff: (tensorPtr: number, otherPtr: number) => number;
    _tensor_squared_diff_scalar: (tensorPtr: number, scalar: number) => number;
